...
step1 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_1_getparams_dag-multi-agenticai-iot-cc4a")
step2 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_2_kafka_createtopic_dag-multi-agenticai-iot-cc4a")
step3 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-multi-agenticai-iot-cc4a")
step4 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_4_kafka_preprocess_dag-multi-agenticai-iot-cc4a")
step5 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_5_kafka_machine_learning_dag-multi-agenticai-iot-cc4a")
step6 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_6_kafka_predictions_dag-multi-agenticai-iot-cc4a")
step7 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_7_kafka_visualization_dag-multi-agenticai-iot-cc4a")
step8 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_8_deploy_solution_to_docker_dag-multi-agenticai-iot-cc4a")
step9 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_9_privategpt_qdrant_dag-multi-agenticai-iot-cc4a")
step10 = importlib.import_module("tml-solutions.multi-agenticai-iot-cc4a.tml_system_step_10_documentation_dag-multi-agenticai-iot-cc4a")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-multi-agenticai-iot-cc4a",
